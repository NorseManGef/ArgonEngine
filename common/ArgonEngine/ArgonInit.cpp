...
SDL_SetNumberProperty(props, SDL_PROP_WINDOW_CREATE_FLAGS_NUMBER, SDL_WINDOW_OPENGL | SDL_WINDOW_RESIZABLE);
    ...
    void handle_window_event(SDL_Event &e){
        switch (e.window.type) {
            ...
            default:
                std::cout << "In function handle_window_event(): invalid SDL_Event type (not of SDL_EVENT_WINDOW variety). Event: " << e.window.type << std::endl; 
                break;
    ...
    bool handle_event(void* userdata,SDL_Event* event){
        ...
        //Handle events
        {
            ...
            if( e.type == SDL_EVENT_QUIT )
            {
                ...
                SDL_Keycode key_c =SDL_GetKeyFromScancode(e.key.scancode, e.key.mod, e.key.down);
