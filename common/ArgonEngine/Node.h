...
/**
 * @brief The Node class is the base building block for
 * almost all in game objects.
 * @details
 * While using the Node class is not required for any
 * functionality of the engine, it provides alot of useful
 * functionality, such as handling transformations, and
