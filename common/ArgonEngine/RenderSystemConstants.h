...
//
/**
 * @brief This file provides several groups of constants
...
//! @brief This enum represents the various possible blend
//! operations. Their functionality matches the OpenGL blend
...
//! @brief This represents the draw style to use for a
//! VertexArray.
enum DrawType {
    //! The vertexes are used to create list of triangles,
    //! where the last two vertices of one triangle are the
    ...
    kDrawTriangleFan //!< The first vertex is the first
                     ...
                     //!< vertex. This mode is relatively
                     //!< obscure.
};
