...
/**
 * @brief
 * Provides an Extension Handler for image data, and the
 * class used to auto-load common-types.
 * @file VirtualResourceImage.h
 * @author Skyler Saleh
 *
 * @details
 * This file defines the base class for all virtual image
 * data.
 **/
...
namespace Argon {
/**
 * @brief The base class for all Extension Handlers that
 * represent virtual image data.
 * @details
