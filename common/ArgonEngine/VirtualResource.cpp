...
void VirtualResource::initialize() {
    ...
    VirtualResource::all_sources()["http:"] =
        new VirtualResourceCURL("http:/", false);
    VirtualResource::all_sources()["ftp:"] =
        new VirtualResourceCURL("ftp:/", false);
    VirtualResource::all_sources()["sftp:"] =
        new VirtualResourceCURL("sftp:/", false);
    VirtualResource::all_sources()["pop3:"] =
        new VirtualResourceCURL("pop3:/", false);
    VirtualResource::all_sources()["imap:"] =
        new VirtualResourceCURL("imap:/", false);
    VirtualResource::all_sources()["smtp:"] =
        new VirtualResourceCURL("smtp:/", false);
    VirtualResource::all_sources()["scp:"] =
        new VirtualResourceCURL("scp:/", false);
    VirtualResource::all_sources()["ldap:"] =
        new VirtualResourceCURL("ldap:/", false);

    VirtualResource::all_sources()["http-rw:"] =
        new VirtualResourceCURL("http:/", true);
    VirtualResource::all_sources()["ftp-rw:"] =
        new VirtualResourceCURL("ftp:/", true);
    VirtualResource::all_sources()["sftp-rw:"] =
        new VirtualResourceCURL("sftp:/", true);
    VirtualResource::all_sources()["pop3-rw:"] =
        new VirtualResourceCURL("pop3:/", true);
    VirtualResource::all_sources()["imap-rw:"] =
        new VirtualResourceCURL("imap:/", true);
    VirtualResource::all_sources()["smtp-rw:"] =
        new VirtualResourceCURL("smtp:/", true);
    VirtualResource::all_sources()["scp-rw:"] =
        new VirtualResourceCURL("scp:/", true);
    VirtualResource::all_sources()["ldap-rw:"] =
...
VirtualResourceIMPL::Source*
VirtualResourceIO::create_source(const std::string& pa,
                                 const std::string& args) {
    if (pa.size() > 2) {
