...
//! @details A sprite is simply a textured rectangle on the
...
struct InstancedSprites : public Node {
    ...
    void set_transform(size_t index, Node& transform,
                       Vector2f min_tex = Vector2f(0, 0),
                       Vector2f max_tex = Vector2f(1, 1));
};
}; // namespace Argon
