...
Vector2f Screen::framebuffer_size(1, 1);
...
std::string Input::get_mouse_button_string(uint32_t input_id) {
    ...
    if (input_id == kInputIDMouseY)
        return "Y Axis";
    if (input_id == kInputIDMouseHorzScroll)
        return "Horz Scroll";
    if (input_id == kInputIDMouseVertScroll)
        return "Vert Scroll";
    if (input_id == kInputIDMouseLeft)
        return "Left Click";
    if (input_id == kInputIDMouseRight)
        return "Right Click";
    if (input_id == kInputIDMouseMiddle)
        return "Middle Click";
    std::stringstream s;
...
std::string Input::get_key_string(uint32_t input_id) {
    ...
    case kInputIDRight:
        return "Right";
    case kInputIDLeftShift:
        return "Left Shift";
    case kInputIDRightShift:
        return "Right Shift";
    case kInputIDLeftControl:
        return "Left Control";
    case kInputIDRightControl:
        return "Right Control";
    case kInputIDLeftAlt:
        return "Left ALT";
    case kInputIDRightAlt:
        return "Right ALT";
    case kInputIDTab:
        return "Tab";
    case kInputIDEnter:
        return "Enter";
    case kInputIDBackspace:
        return "Backspace";
    case kInputIDInsert:
        return "Insert";
    case kInputIDDelete:
    ...
    case kInputIDKP9:
        return "Keypad 9";
    case kInputIDKPDivide:
        return "Keypad Divide";
    case kInputIDKPMultiply:
        return "Keypad Multiply";
    case kInputIDKPSubtract:
        return "Keypad Subtract";
    case kInputIDKPAdd:
        return "Keypad Add";
    case kInputIDKPDecimal:
        return "Keypad Decimal";
    case kInputIDKPEqual:
        return "Keypad Equal";
    case kInputIDKPEnter:
        return "Keypad Enter";
    case kInputIDPrintScreen:
        return "Print Screen";
    case kInputIDNumLock:
        return "NUM Lock";
    case kInputIDCapsLock:
        return "CAPS Lock";
    case kInputIDScrollLock:
        return "Scroll Lock";
    case kInputIDPause:
        return "Pause";
    case kInputIDLeftSuper:
        return "Left Super";
    case kInputIDRightSuper:
        return "Right Super";
    case kInputIDMenu:
        return "Menu";

    default:
        return std::string() + char(input_id);
    }
}
std::string Input::get_window_string(uint32_t input_id) {
    switch (input_id) {
    case kInputIDWindowInactive:
        return "Inactive";
    case kInputIDWindowHasMouse:
        return "Has Mouse";
    case kInputIDWindowMinimized:
        return "Minimized";
    }
    std::stringstream s;
...
MAKE_VISIT_IMPL(InputState, {
    ADD_VAR(value);
    ADD_VAR(magnitude);
    ADD_VAR(magnitude_decay);
    ADD_VAR(distance);
    ADD_VAR(integral);
    ADD_VAR(filtered_value);
    ADD_VAR(filter_ratio);
    ADD_VAR(last_time);
    ADD_VAR(offset);
});
