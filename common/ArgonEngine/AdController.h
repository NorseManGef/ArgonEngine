 ...
 * @date   June 15, 2013
 *
 * @brief This file implemements an abstract interface for
 * displaying in-app advertisements. Ads will be shown when
 * there is any instances of this class that are not hidden.
 **/
