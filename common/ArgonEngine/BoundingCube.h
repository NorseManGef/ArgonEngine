...
/**
 * @brief This file contains the declaration of the Bounding
 * Cube class.
 * @file RenderAPI.h
 * @author Skyler Saleh
 **/
 ...
 * @details An AABB is used for various things in the engine
 * as an efficient collision primitive, such as the broad
...
struct BoundingCube : public ReflectionBase {
    ...
    /// Get the furthest vertex of the cube in a specific
    /// direction
    Vector3f get_negative_vertex(Vector3f normal) const;
    /// Returns a new bounding cube that contains this
    /// bounding cube when it is transformed by a matrix.
