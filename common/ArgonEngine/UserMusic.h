...
/**
 * @brief
 * This file implements an abstract interface for
 * controlling the music player on certain devices. It
 * serves as a hint and can be arbitrarily ignored by the
...
/**
 * @brief
 * This class implements an abstract interface for
 * controlling the music player on certain devices. It
 * serves as a hint and can be arbitrarily ignored by the
 * Hardware Abstraction Layer(HAL).
 **/
class UserMusic {
  ...
  public:
    ...
    //! This is used by the HAL to tell the application
    //! whether User Music is supported.
    static void set_supported_(bool b) { supported_ = b; }
    //! This is used by the hal to explicitly set the
    //! current state.
