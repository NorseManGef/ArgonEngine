...
if(PIPEWIRE_FOUND)
  ...
  FindLibraryAndSONAME("pipewire-0.3" LIBDIRS ${PIPEWIRE_LIBRARY_DIRS})
  if(PIPEWIRE_0.3_LIB)
    list(APPEND CONDITIONAL_DEFINES
      SDL_AUDIO_DRIVER_PIPEWIRE_DYNAMIC="${PIPEWIRE_0.3_LIB_SONAME}"
      SDL_CAMERA_DRIVER_PIPEWIRE_DYNAMIC="${PIPEWIRE_0.3_LIB_SONAME}"
      HAVE_PIPEWIRE_SHARED=1
    )
  endif(PIPEWIRE_0.3_LIB)
...
if(PULSE_FOUND)
  ...
  FindLibraryAndSONAME("pulse" LIBDIRS ${PULSE_LIBRARY_DIRS})
  if(PULSE_LIB)
    list(APPEND CONDITIONAL_DEFINES
      SDL_AUDIO_DRIVER_PULSEAUDIO_DYNAMIC="${PULSE_LIB_SONAME}"
      HAVE_PULSEAUDIO_SHARED=1
    )
  endif(PULSE_LIB)
endif()
...
if(JACK_FOUND)
  ...
  FindLibraryAndSONAME("jack" LIBDIRS ${JACK_LIBRARY_DIRS})
  if(JACK_LIB)
    list(APPEND CONDITIONAL_DEFINES
      SDL_AUDIO_DRIVER_JACK_DYNAMIC="${JACK_LIB_SONAME}"
    )
  endif(JACK_LIB)
endif(JACK_FOUND)
...
if(WAYLAND_FOUND)
  ...
  FindLibraryAndSONAME(wayland-client LIBDIRS ${WAYLAND_LIBRARY_DIRS})
  ...
  if(WAYLAND_EGL_FOUND)
    ...
    FindLibraryAndSONAME(wayland-egl LIBDIRS ${WAYLAND_EGL_LIBRARY_DIRS})
  ...
  if(WAYLAND_CURSOR_FOUND)
    ...
    FindLibraryAndSONAME(wayland-cursor LIBDIRS ${WAYLAND_CURSOR_LIBRARY_DIRS})
  ...
  if(XKBCOMMON_FOUND)
    ...
    FindLibraryAndSONAME(xkbcommon LIBDIRS ${XKBCOMMON_LIBRARY_DIRS})
  endif(XKBCOMMON_FOUND)

  if(WAYLAND_CLIENT_LIB AND WAYLAND_EGL_LIB AND WAYLAND_CURSOR_LIB AND XKBCOMMON_LIB)
    list(APPEND CONDITIONAL_DEFINES
      SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC="${WAYLAND_CLIENT_LIB_SONAME}" 
      SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_EGL="${WAYLAND_EGL_LIB_SONAME}"
      SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_CURSOR="${WAYLAND_CURSOR_LIB_SONAME}"
      SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_XKBCOMMON="${XKBCOMMON_LIB_SONAME}"
      HAVE_WAYLAND_SHARED=1
    )
  endif(WAYLAND_CLIENT_LIB AND WAYLAND_EGL_LIB AND WAYLAND_CURSOR_LIB AND XKBCOMMON_LIB)
  ...
  if(LIBDECOR_FOUND)
    ...
    FindLibraryAndSONAME(decor-0 LIBDIRS ${LIBDECOR_LIBRARY_DIRS})
    if(DECOR_0_LIB)
      list(APPEND CONDITIONAL_DEFINES
        HAVE_WAYLAND_LIBDECOR_SHARED=1
        SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_LIBDECOR="${DECOR_0_LIB_SONAME}"
      )
    endif(DECOR_0_LIB)
...
if(FRIBIDI_FOUND)
  ...
  FindLibraryAndSONAME("fribidi" LIBDIRS ${FRIBIDI_LIBRARY_DIRS})
  if(FRIBIDI_LIB)
    list(APPEND CONDITIONAL_DEFINES
      SDL_FRIBIDI_DYNAMIC="${FRIBIDI_LIB_SONAME}"
      HAVE_FRIBIDI_SHARED=1
    )
  endif(FRIBIDI_LIB)
endif(FRIBIDI_FOUND)
...
if(LIBTHAI_FOUND)
  ...
  FindLibraryAndSONAME("thai" LIBDIRS ${LIBTHAI_LIBRARY_DIRS})
  if(THAI_LIB)
    list(APPEND CONDITIONAL_DEFINES
      SDL_LIBTHAI_DYNAMIC="${THAI_LIB_SONAME}"
      HAVE_LIBTHAI_SHARED=1
    )
  endif(THAI_LIB)
endif(LIBTHAI_FOUND)
