...
set(HAVE_ISINF 1)
set(HAVE_ISINFF 1)
set(HAVE_ISINF_FLOAT_MACRO 1)
set(HAVE_ISNAN 1)
set(HAVE_ISNANF 1)
set(HAVE_ISNAN_FLOAT_MACRO 1)
set(HAVE_LOG 1)
set(HAVE_LOGF 1)
set(HAVE_LOG10 1)
set(HAVE_LOG10F 1)
...
set(HAVE_POSIX_FALLOCATE 1)
set(HAVE_SIGACTION 1)
set(HAVE_SIGTIMEDWAIT 1)
set(HAVE_SA_SIGACTION 1)
set(HAVE_ST_MTIM 1)
set(HAVE_SETJMP 1)
...
set(HAVE_PPOLL 1)
set(HAVE__EXIT 1)
set(HAVE_GETRESUID 1)
set(HAVE_GETRESGID 1)
set(HAVE_LINUX_INPUT_H 1)
set(SDL_INPUT_LINUXEV 1)
set(HAVE_HIDAPI 1)
# set(HAVE_LIBUSB 1)
# set(HAVE_LIBUSB_H 1)
# set(HAVE_HIDAPI_LIBUSB 1)
set(HAVE_SDL_HIDAPI 1)
set(SDL_JOYSTICK_HIDAPI 1)
set(HAVE_SDL_JOYSTICK 1)
set(HAVE_HIDAPI_JOYSTICK 1)
set(SDL_JOYSTICK_LINUX 1)
set(SDL_JOYSTICK_VIRTUAL 1)
set(HAVE_VIRTUAL_JOYSTICK 1)
set(SDL_HAPTIC_LINUX 1)
set(HAVE_SDL_HAPTIC 1)
set(SDL_PROCESS_POSIX 1)
set(HAVE_SDL_PROCESS 1)
set(SDL_TIME_UNIX 1)
set(SDL_TIMER_UNIX 1)
set(HAVE_SDL_TIME 1)
set(HAVE_SDL_TIMERS 1)
set(SDL_VIDEO_VULKAN 1)
set(HAVE_VULKAN 1)
set(SDL_VIDEO_RENDER_VULKAN 1)
set(HAVE_RENDER_VULKAN 1)
set(SDL_GPU_VULKAN 1)
set(HAVE_SDL_GPU 1)
set(SDL_VIDEO_RENDER_GPU 1)
set(HAVE_RENDER_GPU 1)
set(SDL_POWER_LINUX 1)
set(SDL_FILESYSTEM_UNIX 1)
set(SDL_STORAGE_STEAM 1)
set(SDL_FSOPS_POSIX 1)
set(HAVE_SDL_FSOPS 1)
set(DYNAPI_NEEDS_DLOPEN 1)
set(HAVE_SDL_LOADSO 1)
...
if(PIPEWIRE_FOUND)
  ...
  set(SDL_AUDIO_DRIVER_PIPEWIRE TRUE)
  set(SDL_CAMERA_DRIVER_PIPEWIRE TRUE)
...
if(PULSE_FOUND)
  ...
  set(SDL_AUDIO_DRIVER_PULSEAUDIO TRUE)
  set(HAVE_SDL_AUDIO TRUE)
  list(APPEND LIB_LINUX
    PkgConfig::PULSE
  )
...
if(JACK_FOUND)
  set(HAVE_JACK TRUE)
  set(SDL_AUDIO_DRIVER_JACK TRUE)
  set(HAVE_SDL_AUDIO TRUE)
  list(APPEND LIB_LINUX
    PkgConfig::JACK
  )
...
if(ALSA_FOUND)
  set(SDL_AUDIO_DRIVER_ALSA TRUE)
  set(HAVE_ALSA TRUE)
  set(HAVE_SDL_AUDIO TRUE)
  list(APPEND LIB_LINUX
    PkgConfig::ALSA
...
if(WAYLAND_FOUND)
  ...
  if(LIBDECOR_FOUND)
    ...
    set(HAVE_LIBDECOR_H TRUE)
    list(APPEND LIB_LINUX
      PkgConfig::LIBDECOR
    )
  endif(LIBDECOR_FOUND)

  set(SDL_VIDEO_DRIVER_WAYLAND TRUE)
endif(WAYLAND_FOUND)
...
if(X11_FOUND)
  ...
  if(HAVE_XGENERICEVENT)
    set(SDL_VIDEO_DRIVER_X11_SUPPORTS_GENERIC_EVENTS TRUE)
  endif()

  if(HAVE_XCURSOR_H)
    set(HAVE_X11_XCURSOR TRUE)
    set(SDL_VIDEO_DRIVER_X11_XCURSOR TRUE)
  endif(HAVE_XCURSOR_H)

  if(HAVE_XDBE_H)
    set(HAVE_X11_XDBE TRUE)
    set(SDL_VIDEO_DRIVER_X11_XDBE TRUE)
  endif(HAVE_XDBE_H)

  check_include_file("X11/XKBlib.h" HAS_XKBLIB)

  if(HAS_XKBLIB)
    set(SDL_VIDEO_DRIVER_X11_HAS_XKBLIB TRUE)
  endif(HAS_XKBLIB)

  if(HAVE_XINPUT2_H)
    set(HAVE_X11_XINPUT TRUE)
    set(SDL_VIDEO_DRIVER_X11_XINPUT2 TRUE)
    ...
    if(HAVE_XINPUT2_SCROLLINFO)
      set(SDL_VIDEO_DRIVER_X11_XINPUT2_SUPPORTS_SCROLLINFO TRUE)
    endif()
    ...
    if(HAVE_XINPUT2_MULTITOUCH)
      set(SDL_VIDEO_DRIVER_X11_XINPUT2_SUPPORTS_MULTITOUCH TRUE)
    endif()
    ...
    if(HAVE_XINPUT2_GESTURE)
      set(SDL_VIDEO_DRIVER_X11_XINPUT2_SUPPORTS_GESTURE TRUE)
    endif()
  ...
  if(HAVE_XFIXES_H_ AND HAVE_XINPUT2_H)
    ...
    set(SDL_VIDEO_DRIVER_X11_XFIXES TRUE)
    set(HAVE_X11_XFIXES TRUE)
  endif(HAVE_XFIXES_H_ AND HAVE_XINPUT2_H)

  if(HAVE_XSYNC_H)
    set(SDL_VIDEO_DRIVER_X11_XSYNC TRUE)
    set(HAVE_X11_XSYNC TRUE)
  endif(HAVE_XSYNC_H)

  if(HAVE_XRANDR_H)
    set(SDL_VIDEO_DRIVER_X11_XRANDR TRUE)
    set(HAVE_X11_XRANDR TRUE)
  endif(HAVE_XRANDR_H)

  if(HAVE_XSHAPE_H)
    set(SDL_VIDEO_DRIVER_X11_XSHAPE TRUE)
    set(HAVE_X11_XSHAPE TRUE)
  endif(HAVE_XSHAPE_H)

  if(HAVE_XTEST_H)
    set(SDL_VIDEO_DRIVER_X11_XTEST TRUE)
...
if(LIBURING_FOUND)
  ...
  if(HAVE_LIBURING_H)
    set(HAVE_LIBURING_LIBURING TRUE)
    set(HAVE_LIBURING_H TRUE)
...
if(FRIBIDI_FOUND)
  ...
  set(HAVE_FRIBIDI_H TRUE)
endif(FRIBIDI_FOUND)

pkg_check_modules(LIBTHAI IMPORTED_TARGET libthai)
if(LIBTHAI_FOUND)
  set(HAVE_LIBTAI TRUE)
  set(HAVE_LIBTHAI_H TRUE)
endif(LIBTHAI_FOUND)
...
if(HAVE_PTHREADS)
  ...
  if(HAVE_RECURSIVE_MUTEXES)
    set(SDL_THREAD_PTHREAD_RECURSIVE_MUTEX TRUE)
  else()
    check_c_source_compiles("
        #include <pthread.h>
        int main(int argc, char **argv) {
    ...
    if(HAVE_RECURSIVE_MUTEXES_NP)
      set(SDL_THREAD_PTHREAD_RECURSIVE_MUTEX_NP TRUE)
    endif()
  endif()
  ...
  if (HAVE_PTHREAD_H)
    ...
    if (HAVE_PTHREAD_NP_H)
      ...
      set(HAVE_PTHREAD_NP_H TRUE)
      set(HAVE_PTHREAD_SET_NAME_NP TRUE)
    endif()
...
cmake_pop_check_state()
if(HAVE_OPENGL)
  set(SDL_VIDEO_OPENGL TRUE)
  set(SDL_VIDEO_RENDER_OGL TRUE)
endif(HAVE_OPENGL)
...
if(HAVE_OPENGLES_V1)
  ...
  set(SDL_VIDEO_OPENGL_ES TRUE)
endif(HAVE_OPENGLES_V1)
if(HAVE_OPENGLES_V2)
  set(HAVE_OPENGLES TRUE)
  set(SDL_VIDEO_OPENGL_ES2 TRUE)
  set(SDL_VIDEO_RENDER_OGL_ES2 TRUE)
...
if(HAVE_LINUX_VIDEODEV2_H)
  set(SDL_CAMERA_DRIVER_V4L2 TRUE)
...
if(NOT HAVE_LASX)
  set(SDL_DISABLE_LASX TRUE)
endif(NOT HAVE_LASX)

if(NOT HAVE_ARMNEON)
  set(SDL_DISABLE_NEON TRUE)
